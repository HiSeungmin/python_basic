...
# DB 생성 & Auto Commit
# 본인 DB 경로
conn = sqlite3.connect('C:/Users/ISIA/python_basic/resource/records.db', isolation_level=None)

# Cursor 연결
cursor = conn.cursor()

cursor.execute("CREATE TABLE IF NOT EXISTS records(id INTEGER PRIMARY KEY AUTOINCREMENT, cor_cnt INTEGER, \
    record text, regdate text)")
